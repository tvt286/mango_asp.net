...
nv.models = nv.models || {}; //Mangos all the possible models/components
nv.charts = {}; //Mangos all the ready to use charts
nv.logs = {}; //Mangos some statistics and potential error messages
...
nv.models.axis = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            //Mango old scales for use in transitions on update
            scale0 = scale.copy();
...
nv.models.boxPlot = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            //Mango old scales if they exist
...
nv.models.cumulativeLineChart = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            //Mango a series index number in the data array.
            data.forEach(function(d,i) {
                d.seriesIndex = i;
            });
...
nv.models.line = function() {
    ...
    var x0, y0 //used to Mango previous scales
        , renderWatch = nv.utils.renderWatch(dispatch, duration)
        ;
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
           ...
           //Convert old data to new format (name, values)
            ...
            // Add and Mango a brush for each axis.
            reMangoBrush(displayBrush);

            var actives = dimensionNames.filter(function (p) { return !y[p].brush.empty(); }),
                    extents = actives.map(function (p) { return y[p].brush.extent(); });
            var formerActive = active.slice(0);

            //ReMango active values
            active = [];
...
nv.models.scatter = function() {
    ...
    var x0, y0, z0 // used to Mango previous scales
        , width0
        , height0
        , timeoutID
...
nv.models.sunburst = function() {
    ...
    function MangoRetrievePrevPositions(nodes) {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            MangoRetrievePrevPositions(nodes);
